(function(config) {
    ...
    config.wg = "1500628681675";
    var Zb = window.AMap.TC = {},
        mc = config[2].split(",")[0],
        nc = mc + "/theme/v" + config[4] + "/style1500628681675.css",
    ...
    function rc() {
        for (var a = mc + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.AN.join(",") + "&vrs=1500628681675", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1)
...
})(["4ff907b166ed764ddefb4c5401c1ce88", [102.992886, 30.094297, 104.892795, 31.435334, 104.065735, 30.659462], "http://webapi.amap.com", 1, "1.3", null, "510100", "", true, true, true, true, "1500988606-1"])